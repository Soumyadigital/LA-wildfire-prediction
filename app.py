...
# Load the dataset
df = pd.read_csv(r'C:/Users/SOUMYAJIT/Downloads/LA_wildfire_pred_1/datasets/legit_sample (1).csv')
processed_data = pd.read_csv(r'C:/Users/SOUMYAJIT/Downloads/LA_wildfire_pred_1/datasets/legit_sample_vectors.csv')

# Load the trained XGBoost model
with open('C:/Users/SOUMYAJIT/Downloads/LA_wildfire_pred_1/saved_models/XGboost_wildfire_pred_model (1).sav', 'rb') as file:
